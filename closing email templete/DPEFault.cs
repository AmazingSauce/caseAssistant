...
{
    public partial class DPEFault : Form
    {
        public DPEFault()
        {
            InitializeComponent();
        ...
        private void DPEFault_Load(object sender, EventArgs e)
        {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string kbArticle = "000195084 ";

            Clipboard.SetText(kbArticle);

            MessageBox.Show("KB article 000195084 has been copied to your clipboard");
